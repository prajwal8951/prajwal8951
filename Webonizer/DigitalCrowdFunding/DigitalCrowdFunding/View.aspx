<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="View.aspx.cs" MasterPageFile="~/Site.Master"  Inherits="DigitalCrowdFunding.WebForm1" %>
...
<asp:Content  ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table>
        <tr>
            <td>
                <asp:Button id="btnInvest" Text="Invest"  CssClass="btn btn-default" runat="server"/>
            </td>
            <td>
                <asp:Button id="btnback" Text="Invest"  CssClass="btn btn-default" runat="server" />
            </td>
        </tr>
    </table>
